                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="580" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr class="es-visible-amp-html-only es-mobile-hidden">
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" align="center"><a href target="_blank"><img src="https://res.cloudinary.com/dzzobtu8a/image/upload/v1582069994/download_kla9y9.png" alt style="display: block;" width="130"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" style="background-color: #0f5061;" esd-custom-block-id="6340" bgcolor="#0F5061" align="center">
                                                                    ...
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table style="background-color: #ffecd1; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffecd1">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30b es-p30r es-p30l" esdev-links-color="#ffa73b" align="center"><a target="_blank" href style="color: #ffa73b;">We’re here, ready to talk</a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="6342" align="center">
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" align="center" style="background-color: white">
                                            <tbody>
                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p25t">
                                                                                        <p>You received this email because you just signed up for a new idove account. If it looks weird, <strong><a class="view" target="_blank" href="https://viewstripo.email">view it in your browser</a></strong>.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p25t" align="left">
                                                                                        <p>African Union Headquarters<br>P.O. Box 3243, Roosvelt Street W21K19<br>Addis Ababa, <br>Ethiopia.<br>Tel: +251 11 551 77 00<br>Fax: +251 11 551 78 44</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
