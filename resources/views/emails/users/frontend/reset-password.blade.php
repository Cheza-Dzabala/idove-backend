        ...
        <table style="border-radius: 4px; border-collapse: separate; background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
            ...
            <tr>
                <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="center">
                    <p>You seem to be having some trouble with your login.</p>
                </td>
            </tr>
            <tr>
                <td class="esd-block-text es-p20t es-p20b es-p30r es-p30l es-m-txt-l" bgcolor="#ffffff" align="center">
                    <p>Please follow <a href="{{ env('FRONTEND_PATH').'/reset-password?token='.$token }}">this link</a> to activate your account. <br/>
                    </p>
                    <small>If you cannot click the link, copy and past this url into your browser. {{ env('FRONTEND_PATH').'/reset-password?token='.$token }}</small>
                </td>
            </tr>

            <tr>
                <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                    <p>If something happens and you cannot reset your password, please reach out to the idove admins at:
