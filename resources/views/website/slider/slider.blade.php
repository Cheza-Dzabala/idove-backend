<div class="main-slider">
    <div class="splide" id="main-slider">
        <div class="splide__arrows">
            ...
            opacity: 0.5;">
                <img src={{ asset('public/images/icons/back.png') }} / style="height: 40px" />
            </button>
            ...
            background-color: black;
            opacity: 0.5;">
                <img src={{ asset('public/images/icons/forward.png') }} style="height: 40px" />
            </button>
        </div>
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide">
                    <img src={{ asset('public/images/people.png') }} style="width: 100%;" />
                </li>
                <li class="splide__slide">
                    <img src={{ asset('public/images/people.png') }} style="width: 100%;" />
                </li>
