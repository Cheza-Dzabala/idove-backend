<section>
    <div class="border-b-2 ">
        <h1 class="border-b-2 border-red-800 w-28 text-lg mb-0 text-red-800">Our Presence</h1>
    </div>
    <div class="mb-5">
        <div id="map-container" style="width: 60vw;
        height: 500px;"></div>
    </div>
</section>
        ...
        let map = new Datamap({
            ...
            geographyConfig: {
                ...
                popupTemplate: function(geography, data) {
                    ...
                    return '<div class="hoverinfo" style="padding: 15px; margin-top: 100vh;">' +
