    ...
    <section class="mt-5">
        <div class="border-b-2 mb-4 flex justify-between">
            ...
            <div class="section-links">
                <a onclick="openTab('gallery','videos')" class="text-sm text-au-red mr-4 cursor-pointer">Images</a>
                <a onclick="openTab('videos', 'gallery')" class="text-sm text-au-red cursor-pointer">Videos</a>
            </div>
        </div>
        <div id="gallery" role="tabpanel">
...
@section('js')
    <script>
        ...
        function openTab(tabName, closeTab) {
